...
$_CALEM_dist=array(
	...
	'client_lang_list'=>array(
      ...
      //ru
      'CalemMsg_ru.js'=> array('AjxMsg'=>array('AjxMsg_ru'), 
						'I18nMsg'=>array('I18nMsg_ru', 'I18nMsg_ru_RU'),
...
@include _CALEM_DIR_ . 'server/modules/asset/asset_conf.php';
@include _CALEM_DIR_ . 'server/modules/asset/asset_conf.custom.php';
